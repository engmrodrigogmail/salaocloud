    ...
    <section className="py-24 bg-secondary">
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-sm border border-primary/20 bg-card p-12 md:p-16 text-center">
          ...
          <p className="text-sm md:text-base font-medium text-primary mb-10 max-w-xl mx-auto">
            7 dias de acesso completo e gratuito. Sem cartão de crédito, sem compromisso. Cancele quando quiser.
          </p>
          <Button
            size="lg"
            ...
            asChild
          >
            <Link to="/auth?mode=signup&trial=1">
