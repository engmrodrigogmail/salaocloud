...
AS $function$
  ...
  SELECT
    ...
    -- Comanda recém-criada (ainda sem itens lançados) fica visível a qualquer
    -- profissional ativo do salão, para destravar o RETURNING do INSERT.
    -- Assim que o primeiro item é lançado, a regra normal de privacidade volta
    -- a valer (cada profissional só vê os itens das suas próprias comandas).
    OR (
